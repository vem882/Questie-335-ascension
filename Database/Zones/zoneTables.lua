...
--- This table stores the locations of each subZone and it's parent zoneID
--- Imported from pfQuest-ascension
---@type table<AreaId, AreaId, Width, Height, X, Y>
ZoneDB.private.subZoneCoordinates = {
...
--- This table stores the name of each zone mapped to it's AreaID
--- Imported from pfQuest-ascension
---@type table<AreaId, AreaName>
ZoneDB.private.zoneNames = {
    [1]="Dun Morogh",
    [2]="Longshore",
    [3]="Badlands",
    [4]="Blasted Lands",
